...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // 4. Smooth Card Hover Enhancement (Native, Non-Blocking)
  // Draggable picking removed to ensure 100% silky-smooth native scrolling on all mobile & desktop devices
